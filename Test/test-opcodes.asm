...
test_compound_opcodes	equ	1
test_fails 				equ 1
test_ixcb_r2 			equ	0	; needs option --ixcb=r2
test_ixcb_xh 			equ 0	; needs option --ixcb=xh
test_hd64180			equ 1	; needs option --hd64180
test_8080_opcodes		equ 0	; needs option --8080
test_8080_syntax		equ 0	; TODO
...
; –––––––––––––––––––––––––––––––––––––––––––––––––
; 			test 8080 opcodes (z80 syntax)
; –––––––––––––––––––––––––––––––––––––––––––––––––


; ––––––––––––––––––––––––––––––––––
; no arguments / single variant:
	ccf
	cpl
	daa
	di
